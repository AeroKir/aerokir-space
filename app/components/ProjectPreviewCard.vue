<template>
  <article class="w-[95vw] 2xl:w-[1355px] h-auto relative mb-16 md:mb-24 px-4 lg:px-0">
    <h2 class="absolute -top-8 md:-top-12 2xl:-top-[110px] left-2 lg:left-0 text-4xl md:text-6xl 2xl:text-[128px]/[128px] font-heading font-bold text-primaryDark dark:text-primaryLight z-40">
      <NuxtLink :to="localePath(`/projects/${slug}`)">
        {{ t(props.title) }}
      </NuxtLink>
    </h2>

    <p class="flex items-center absolute top-3 md:top-1 lg:top-[7%] right-2 md:right-6 lg:right-0 uppercase text-sm md:text-base 2xl:text-2xl font-body z-40 [text-shadow:0_1px_2px_#9DA3A4] dark:[text-shadow:0_2px_3px_#000000]">
    ...
    <div class="relative w-[88vw] 2xl:w-[1120px] 2xl:h-[550px] bg-sepiaDarken dark:bg-primaryDarken lg:ml-[145px] py-9 px-6 mb-10 last:mb-0 flex justify-center items-center">
      <div class="relative group w-full md:w-[70vw] 2xl:w-[836px] h-auto">
        <NuxtLink
    ...
    <NuxtLink
      ...
      class="group absolute w-20 h-20 md:w-[150px] md:h-[150px] lg:w-[180px] lg:h-[180px] rounded-full bg-primaryDark dark:bg-primaryLight
         bottom-[30px] right-[1%] md:right-[3%] lg:right-[1%] text-xl z-40
